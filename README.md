...
> A fork of the [Remix Blues Stack](https://github.com/remix-run/blues-stack) for making web3 Progressive Web Apps.

<img src="ghost_mascot.png" alt="Primix Stack" height="600">
...
- NOTE: you must install Docker and Docker Compose locally if you haven't yet.
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create app-23f9
  fly apps create app-23f9-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app app-23f9
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app app-23f9-staging
  ```
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name app-23f9-db
  fly postgres attach --app app-23f9 app-23f9-db

  fly postgres create --name app-23f9-staging-db
  fly postgres attach --app app-23f9-staging app-23f9-staging-db
  ```
